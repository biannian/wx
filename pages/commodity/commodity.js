...
Page({
  data: {
    ...
    toView: 'blue',
    menus:[
      {id:1,fenleimingcheng:"无敌炸鸡"},{id:2,fenleimingcheng:"无敌炸鸡1"},{id:3,fenleimingcheng:"无敌炸鸡1"}
      ,{id:4,fenleimingcheng:"无敌炸鸡1"}
      ,{id:5,fenleimingcheng:"无敌炸鸡1"}
      ,{id:6,fenleimingcheng:"无敌炸鸡1"},{id:7,fenleimingcheng:"无敌炸鸡1"}
      ,{id:8,fenleimingcheng:"无敌炸鸡1"}
      ,{id:9,fenleimingcheng:"无敌炸鸡1"}
      ,{id:10,fenleimingcheng:"无敌炸鸡1"}
      ,{id:11,fenleimingcheng:"无敌炸鸡1"}
      ,{id:12,fenleimingcheng:"无敌炸鸡1"}
      ,{id:13,fenleimingcheng:"无敌炸鸡1"}
      ,{id:14,fenleimingcheng:"无敌炸鸡1"}
      ,{id:15,fenleimingcheng:"无敌炸鸡1"}
      ,{id:16,fenleimingcheng:"无敌炸鸡1"}
      ,{id:17,fenleimingcheng:"无敌炸鸡1"}
    ],
    selectedMenuId: 1,
